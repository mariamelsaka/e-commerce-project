            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Paids</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    @php
                                        $K = \App\Models\OrderDetail::select(\DB::raw("(SUM(price * amount * (1.0 - discount / 100.0))) AS K"))->first()->K;
                                    @endphp
                                    {{ceil($K * 100.0) / 100.0}}
                                </div>
                            </div>
